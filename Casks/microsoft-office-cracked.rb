cask :v1 => 'microsoft-office-cracked' do
  version :latest
  sha256 :no_check

  # TODO: this link is for the official version not the cracked version, so it needs a link for downloading the cracked version
  url 'http://officecdn.microsoft.com/pr/MacOffice2011/en-US/MicrosoftOffice2011.dmg'
  name 'Microsoft Office'
  homepage 'http://www.microsoft.com/mac'
  license :commercial

  pkg 'Office Installer.mpkg'
